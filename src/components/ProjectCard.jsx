...
const ProjectCard = ({ onButtonClick }) => {
    ...
    return (
        <div className='relative bg-gray-300 px-0 md:px-5 z-20 flex items-center justify-center'
            ref={wrapperRef}
        >
            <div className="flex container flex-col items-center justify-center md:mt-20 mt-10"
                ref={contentRef}
            >
                {projectPreview.map((items) => {
                    ...
                    return (
                        <div
                            key={id}
                            className="w-full lg:w-[90vw] h-auto mb-5 sm:mb-8 md:mb-0  px-2 sm:px-4 py-3 sm:py-5 md:py-10 flex items-center justify-center"
                        >
                            ...
                            <div
                                className='card flex flex-col md:flex-row justify-between
                            px-4 sm:px-6 md:px-10 py-5 sm:py-6 md:py-10
                            bg-slate-900 items-center border-2 border-gray-300 rounded-lg overflow-hidden gap-10 shadow-md shadow-gray-500'
                            >
                                    ...
                                    <div className="mt-4 sm:mt-6 md:mt-10 flex flex-col xs:flex-row justify-between gap-3 md:gap-1 w-full">
                                        ...
                                        <div className="flex gap-1">
                                            ...
                                            <button className="preview-btn px-2 sm:px-5 py-2.5 bg-transparent hover:shadow-[0_0_20px_rgba(255,255,255,0.1)] w-full xs:w-auto"
                                                onClick={() => {
                                                    const actions = {
                                                        1: () => window.open("https://github.com/Soumya1974/CashFlow", "_blank"),
                                                        2: () => window.open("https://github.com/Soumya1974/Animation-lib", "_blank"),
                                                        3: () => onButtonClick(),
                                                    };
                                                    actions[id]?.();
                                                }}
